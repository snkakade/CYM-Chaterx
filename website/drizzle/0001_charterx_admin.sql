...
CREATE INDEX IF NOT EXISTS idx_invoices_lead_id ON invoices(lead_id) WHERE lead_id IS NOT NULL;

CREATE TABLE IF NOT EXISTS sequences (key TEXT PRIMARY KEY, value INTEGER NOT NULL);
INSERT INTO sequences(key, value) VALUES ('invoice', 1000) ON CONFLICT(key) DO NOTHING;
